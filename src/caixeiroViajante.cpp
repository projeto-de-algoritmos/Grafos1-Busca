...
int main()
{
    ...
    int rota = caixeiroViajante(graph, s);
    cout << "A menor rota para percorrer as cidades 1-2-3-4-5-1 é:" << rota << " km" << endl;
    cout << "Caminhos propostos: "
         << "1-5-2-3-4-1 ou 1-4-3-2-5-1 ou 1-4-3-5-2-1 ou 1-2-5-3-4-1" << endl;
